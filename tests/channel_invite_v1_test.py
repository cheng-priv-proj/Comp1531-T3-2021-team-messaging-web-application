...
def test_member_invite(clear, register, extract_user, extract_channel, extract_u_id):
...
def test_owner_invite(clear, register, extract_user, extract_channel, extract_u_id):
...
def test_invite_multiple(clear, register, extract_user, extract_channel, extract_u_id): 
...
def test_private_invite(clear, extract_user, extract_channel, extract_u_id):
